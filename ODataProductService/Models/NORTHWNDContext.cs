...
using ODataProductService.Models.Mapping;
...
namespace ODataProductService.Models
{
    public partial class NORTHWNDContext : DbContext
    {
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            //modelBuilder.Entity<Customer>().ToTable("Orders");
            //modelBuilder.Entity<Order>().HasKey(od => new { od.CustomerID });
            
            //modelBuilder.Entity<Order_Detail>().HasKey(od => new { od.OrderID, od.ProductID });
            //modelBuilder.Entity<CustomerDemographic>().HasKey(cd => new { cd.CustomerTypeID });
        }
    }
}
